<?php
session_start();
// 1. Ruta corregida a la conexión (Models está un nivel arriba)
include_once "../Models/base.php";

// 2. Validación de sesión con ruta absoluta al login
...
document.getElementById('categoria').addEventListener('change', function () {
    ...
    // 5. Ruta corregida al controlador que obtiene subcategorías
